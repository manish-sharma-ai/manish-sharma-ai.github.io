...
- Buyer-facing labels such as `Contact Exafuse` and `Request Exafuse review`.
...
In production-safe mode, those routes must point to a safe production index/contact page and use a buyer-facing or source-status label. Public helper text should say: `New Exafuse case/tool deep links will activate after production migration.`
